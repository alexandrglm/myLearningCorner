...
To begin with an example, use a basic sentence such as “_the quick brown fox jumped over the lazy dog_”.

The reasoning for using this sentence in programming examples is because it contains\
