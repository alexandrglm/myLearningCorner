# 02-031\_Finding\_a\_substrings\_using\_FIND\_INDEX\_IN
...
So let's come here and I'm going to make the second one called `query_two` and then I'm going to print out query\_two.
