# 02-025\_Python\_Accessing\_String\_portions
...
I'm going to copy `starter_sentence` right here and let's print this out some say print starter\_sentence and the way you access it is right after the variable that holds this value.
...
And in many other programming languages you would be able to do something like this where I could a starter\_sentence 12 and then set this equal to say a capital A.
...
So first word and I can say starter\_sentence in the syntax in Python is pretty cool the way that you do this is you say zero, colon. So zero is the first element that you want to try to find.
...
And so if I do 0 3 right here and say first-word I can say new\_sentence and just swap the first word in right there.
