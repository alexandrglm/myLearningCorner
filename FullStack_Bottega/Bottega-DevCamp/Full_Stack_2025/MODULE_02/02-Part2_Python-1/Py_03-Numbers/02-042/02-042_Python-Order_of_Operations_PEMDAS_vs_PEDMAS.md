# 02-042\_Python-Order\_of\_Operations(PEMDAS-PEDMAS)
...
So I want you to try to work this out in your head or on paper and be able to say "_OK the output of this calculation should be...._" some number and see how close you can get to understanding the order of operations because this is something that is not specific to python.
