...
So what you're doing is you're saying "_OK, I know that this is the button that's going to be used throughout the app._"

And you add it to the style guide. You say, "_Here is button active. Here is button_\
_inactive. Here is button after clicked. Here's button on hover._"
