...
I say "_if role is equal to admin then I am gonna say can access, else cannot access_".
...
Write a ternary operator that sets "language\_check" to True if "language" is set as "python", and sets it to False if it's not.
