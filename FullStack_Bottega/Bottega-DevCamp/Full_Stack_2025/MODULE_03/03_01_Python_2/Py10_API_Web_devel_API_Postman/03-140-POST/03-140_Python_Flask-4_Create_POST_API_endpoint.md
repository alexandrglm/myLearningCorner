# 03-140\_Python\_Flask-4\_Create\_POST\_API\_endpoint
...
The GET endpoint will be: ' app\_111.py' .
...
Now the very first thing that we want to do is to be able to start adding guides to this application. So I think that would make sense that that would be the first endpoint that we'd create. So I'm going to come down and let's do this right below guides\_schema. I'm going to create our first endpoint.
