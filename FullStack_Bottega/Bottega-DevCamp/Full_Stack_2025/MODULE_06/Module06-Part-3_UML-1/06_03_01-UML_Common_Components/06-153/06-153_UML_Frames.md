...
* **Object Management Group (OMG)**. _UML 2.5.1 Specification_, Section 7.3: "Frames"
* **ISO/IEC 19501:2005** - UML Notation Standards

### Best Practices

* **Fowler, M.** (2003). _UML Distilled_ - Chapter 3: "Diagram Organization"
* **Arlow, J., & Neustadt, I.** (2005). _UML 2 and the Unified Process_ - Frame Usage Guidelines
