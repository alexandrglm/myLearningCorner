...
* `application.scss` file contains all @import directives.![01-020\_IMG1](https://github.com/user-attachments/assets/75a36ff6-b9e8-4972-a585-ecb18de649d8)
...
* After precompilation and minification, a single optimized CSS file is generated, ready for production.![01-020\_IMG3](https://github.com/user-attachments/assets/47040510-f5f5-47a1-93d0-5e2b1bb101a1)
...
So you do not have if you work in something else such as PHP or dot net or something like that then you can absolutely still use Scss.![01-020\_IMG1](https://github.com/user-attachments/assets/75a36ff6-b9e8-4972-a585-ecb18de649d8)
...
![01-020\_IMG2](https://github.com/user-attachments/assets/669e92d0-8b48-4b6e-8dcd-45281fcd4453)
...
So for bootstrap it has a number of buttons and the buttons may be greyed out of the box for certain prototype applications, but they're not what you would use in a production one.\
So you have to make sure that your custom styles that override this are called afterward and by leveraging import statements then it makes that much easier to control that.\
![01-020\_IMG3](https://github.com/user-attachments/assets/47040510-f5f5-47a1-93d0-5e2b1bb101a1)
