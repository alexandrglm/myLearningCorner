# C01\_Three\_Pixels\_on\_a\_Row
...
1. Colours: R - C - Y\
   3E 88 - 3E 08 - 3E 80
2. Positions: 32 XX YY`A` - `M` - `SA` = C0FE - A init`A` = C100
...
~~**XX-YY - HORIZONTAL - VERTICAL**~~![image](https://github.com/user-attachments/assets/65d64634-2f00-4ace-a56a-3fe543542735)

C000 0% X 0%\
C200 30% X 40%\
C205![image](https://github.com/user-attachments/assets/db8de0ec-9dd6-43f5-b780-4a9666c75ae6)
...
Posición 10 D0![image](https://github.com/user-attachments/assets/ddb2f250-8635-4be8-bbbf-48cdaed3ee91)
...
~~Example 1:Red - Blue("Transparent" as screen bg is the same blue) - Red - Yellow1 0 1 1 1 0 1 0B Ald a,#BA3E BA~~

~~Example 2: **WRONG**Yellow - Cyan - Red - Yellow~~

~~0110 11016D**6D is Cyan - Red - Yellow - Cyan**~~
