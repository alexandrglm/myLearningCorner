...
* All instructions allowed to be executed by the CPU are well-documented, like in the official Z80 documentation, or what were made for/by this chipset lovers as seen in this table example given from [this site](https://clrhome.org/table/) :![IMG\_Z80\_Opcodes](https://github.com/user-attachments/assets/1dcedf84-e6f6-4f69-a924-77d65030a58b)
...
1. '_Z80 full Opcodes table_' - CLRHome [Link](https://clrhome.org/table/)
