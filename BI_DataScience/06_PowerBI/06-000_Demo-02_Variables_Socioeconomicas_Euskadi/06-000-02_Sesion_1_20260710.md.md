...
Análisis y correlación multivariante de factores socioeconómicos y de bienestar en la Comunidad Autónoma de Euskadi.  

El objetivo principal es identificar patrones y evaluar la correlación entre los siguientes bloques de datos:
