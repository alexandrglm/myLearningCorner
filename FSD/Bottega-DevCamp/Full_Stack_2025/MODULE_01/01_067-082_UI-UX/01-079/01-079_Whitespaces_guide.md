...
They say "_I can still read all these and I can fit a lot more of them on a page," right?_

**JH:** Right.

**JC:** But... since we learned how to _scroll?_\
...
Whether that's because you're on a mobile device or you're like "_Hey, we have to be really really meticulous with how much space_\
_we're putting on that axis because maybe people are going to have really_\
_long usernames and we need to be aware of that_."

Or, "_We have this table that needs to have five columns in it. How are we going to fit all_\
_those in?_" And so it's not just saying "_add all the whitespace_."
...
Clients, a lot of times, say "_I just want to open_\
_my phone or my desktop, and I want all my information right there_".\
...
And I hated the way it looked. I didn't know _why_ I hated it. I just knew I was not going to enjoy reading it.
...
That's what really brings a lot of that, like, _energy_ into it. It's what keeps it from being sterile.
...
Then follow that up with going to places like [Dribbble](https://dribbble.com/) and [Behance](https://www.behance.net/) and see the way that other people have been building these types of user interfaces that utilize whitespace in all different kinds of ways.
