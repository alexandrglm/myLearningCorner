# 01-050\_GitHub\_GitLab\_BitBucket\_UseCases
...
* Aware of the AI capabilities, GitHub also offers its named feature _'CodeSpaces'_ on which you can set a web-based IDE for almost any kind of development.
...
Specifically, we're going to be looking at [GitHub](https://www.github.com), we're going to be looking at [GitLab](https://about.gitlab.com/), and we're going to be looking at [BitBucket](https://bitbucket.org/product/).
