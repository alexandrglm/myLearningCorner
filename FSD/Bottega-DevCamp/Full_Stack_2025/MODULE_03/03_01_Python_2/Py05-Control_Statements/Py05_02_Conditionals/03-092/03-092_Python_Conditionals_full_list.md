...
So here we can say something like user\_list and inside of this. We can just create a set of users and then I'm going to create a second list and in this case, I'm going to go\
with another set of users and now we can create a condition that checks these two lists against each other so I can say if the user\_list is equal to the second user\_list you can do something like say they match and that's all you have to do.
