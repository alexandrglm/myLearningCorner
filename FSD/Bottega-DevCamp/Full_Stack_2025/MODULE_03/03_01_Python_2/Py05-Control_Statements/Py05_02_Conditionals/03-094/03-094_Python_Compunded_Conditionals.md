...
So I'm going to say if logged in and not so this is the syntax whenever you want to see if one side is true and the other is false then you can say and not standard\_user.
