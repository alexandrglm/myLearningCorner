...
📌 **Key Rule:** Python follows **PEP 8**, which recommends using **snake\_case** for function names, just like variables.
...
So if I'm going to call this function I can say full\_name and then\
...
whenever we call our full\_name function we're going to pass in different\
...
But I also want to say that the full\_name function is a method that I build into almost every application that I build-out.
...
take in a max value and then you can actually call it max\_value. I'm\
