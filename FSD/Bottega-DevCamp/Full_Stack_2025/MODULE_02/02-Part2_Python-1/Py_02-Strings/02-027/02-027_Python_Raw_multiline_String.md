# MODULE 02 - 027: Pyton: Raw Multi-line String -  + repr()
...
So right here we can see this  is a new line character.

In programming terms, whenever you want a new line character you can use  and the Python interpreter is going to convert that into a new line.
...
So don't get bogged down in the thoughts of "_oh we're just building all these little console apps and getting frustrated because we're not to the point we're building something real yet_.
