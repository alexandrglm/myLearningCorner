...
### This guide mentions more mathematical functions _(logarithms, exponentials, trigonometrics and some constants as Pi, Tau, E, ...)_ that have been introduced in the original guide. However, now is a good time to provide some information on these functions.
...
One is a negative called loss and it's -20.25. So this is a floating-point number that's negative and the next one's a floating-point number called product\_cost at 89.99.
