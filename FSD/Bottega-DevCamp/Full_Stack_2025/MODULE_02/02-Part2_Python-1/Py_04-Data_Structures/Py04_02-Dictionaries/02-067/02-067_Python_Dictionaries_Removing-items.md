# Module 02 - 067: Python - Dictionaries, Removing items / del dic\['key'] - .pop() - .clear() - .remov
...
So I'm going to say removed\_team and set equal to teams.pop everything else stays the same.
