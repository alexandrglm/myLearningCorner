...
For example, we have a name variable, "_Kristine Hudgens_", where I can put a hash mark to split it into two variables.
...
Here, are a few sentences with _“lorem ipsum”_.
