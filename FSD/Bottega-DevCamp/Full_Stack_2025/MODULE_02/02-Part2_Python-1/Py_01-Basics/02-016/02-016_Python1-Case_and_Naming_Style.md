...
However, whenever you have a variable that has multiple words such as post count, the c**ommon convention is to put an underscore in between the words**. \*\*(snake\_case) \*\*
...
So a better example would include num\_one and num\_two.
