# 04-051\_JS\_Integrating\_Conditionals-Ternary
...
In the below function's `return`, use a ternary that returns _"1 point"_, when the `ship` variable is set to _"hit"_. Otherwise, have it return _"You lost a point"_. Then, set the `ship` variable to _"hit"_ or _"miss"_.
